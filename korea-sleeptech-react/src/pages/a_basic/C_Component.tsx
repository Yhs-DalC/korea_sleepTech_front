...
import dog from '@/assets/images/dog01.jpg';
/*
! 컴포넌트(Component)
...
: 파일명이 반드시 대문자로 시작(UpperCamelCase)
  EX) MainContainer, NavBar
  - JS의 일반 함수 형태와 구분(일반 함수 - lowerCamelCase)
...
: rfc, rfce 스니펫 사용시
  ...
  cf) index.tsx 파일명: 폴더명을 활용한 import 위함
      >> 내부의 함수명은 대문자로 수정: 외부에서 인식 가능한 컴포넌트 생성
 */
...
export function Img(){
  ...
  // tsx의 함수형 컴포넌트는 return시 HTML을 반환
  return (
    <div>
      {/* 
