  ...
  return (
    <div>
      ...
      */}
      ...
      <button onClick={function(){console.log('버튼 클릭');}}>클릭(함수를 직접 정의)</button>
      <button onClick={() => console.log('button click')}>클릭(화살표 함수를 직접 정의)</button>

      <hr />
      {/* 부모 컴포넌트(증가/감소 버튼으로 count값 변경) */}
      {/* 속성에서 함수를 직접 정의하는 경우 '화살표 함수 하용 권장' */}
      ...
      2) -handler 끝
        : 이벤트 동작 이름 + handler
        EX) clickHandlerm SignUpSubmitHamdler, mouseEnterHandler
      */}
