...
// 1) indexOf(요소 값): 찾는 요소의 첫 번째 인덱스를 반환(없으면 -1)
console.log(snacks.indexOf('초코송이'));// 1
console.log(snacks.indexOf('꼬깔콘'));// -1

// 2) lastIndexOf(요소 값): 배열의 끝부터 찾는 요소의 첫 번째 인덱스를 반환(없으면 -1)
...
console.log(newLength);// 수정된 배열의 길이를 반환
...
fruits.splice(1, 0, 'strawbarry', 'coconut');
console.log(fruits);// [ 'mango', 'strawbarry', 'coconut', 'orange', 'Banana' ]

// 2) 삭제: splice(시작 인덱스, 삭제할 요소의 개수)
let removedFruits = fruits.splice(1, 2);
console.log(removedFruits);// [ 'strawbarry', 'coconut' ]
