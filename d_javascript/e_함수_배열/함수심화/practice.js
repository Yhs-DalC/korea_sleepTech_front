...
const scores = [75, 64 ,75 ,89, 59, 96, 67, 83];
...
console.log(result);// [ 7, 78.42857142857143 ]
...
console.log(`60점 이상의 점수 개수: ${passingCount2}`);// 60점 이상의 점수 개수: 7
console.log(`60점 이상의 점수 평균: ${passingAverage2}`);// 60점 이상의 점수 평균: 78.42857142857143
...
const filteredWords = (words, substring) => {
  // includes 메소드: 배열, 문자열 등에서 데이터 인자값이 포함되었는지를 검사(boolean값 반환) 
