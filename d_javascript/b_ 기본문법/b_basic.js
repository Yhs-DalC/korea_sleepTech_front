...
//? 식별자 종류별 명명규칙
// 클래스명: 대문자 시작
// 변수, 객체, 함수, 메소드명: 소문자 시작
// +) 여러 단어로 이루어진 식별자의 각 단어의 첫 글자를 대문자로 시작
// >> lowerCamelCase

//? 식별자 뒤 소괄호 O: 함수(단독 사용), 메소드(다른 식별자와 사용: 객체.메소드명())
...
// let userName = prompt('사용자의 이름 입력');
// alert(userName);
...
// : 괄호 안은 HTML태그, 데이터 자체, 결과값이 저장된 변수 삽입 가능
