...
// 1) AND 연산자 && - 논리곱
// : false가 하나라도 있으면 무조건 false
// >> 값이 모두 true일때만 true를 반환

//? cf) 자바스크립트 '단락 평가'
// : 논리연산에서 첫 번째 피연산자 값만으로 해당 식의 결과가 확실할 때, 두 번째 값은 평가하지 않음
...
// +) 초기 JS  tjfrP rufgkadmfh null 데이터의 타입은 object 반환
