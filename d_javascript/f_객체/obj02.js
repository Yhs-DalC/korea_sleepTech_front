...
console.log(dog.favorateToy[1]);// 탱탱볼
...
// 2) 객체의 메소드 안의 this
// : 객체의 변수에 할당되는 함수
// - 메소드 호출 시 this는 해당 메소드를 호출한 객체에 바인딩(bind: 묶다, 고정하다)
...
// >> myObject 즉, 메소드를 호출한 객체 그 자체가 출력
...
//! 객체 내부의 this
// - 선언식 함수, 함수 표현식 VS 화살표 함수의 this 바인딩이 다름
// >> 현재의 객체값을 활용하기 위함이기 때문에 선언적 함수, 함수표현식 사용을 권장