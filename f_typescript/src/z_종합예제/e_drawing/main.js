{
    ...
    function createToolbar() {
        ...
        earserButton.onclick = function () {
            ...
            earserButton.textContent = toolState_1.isEraser ? '팬' : '지우개';
        };
        //# 캔버스 초기화 버튼
        ...
        saveButton.onclick = function () {
            ...
            link.download = 'drawimg.png'; // 저장 파일명
            link.href = canvas_1.toDataURL(); // 이미지 URL생성
    ...
    canvas_1.addEventListener('mouseup', function () {
        isDrawing_1 = false;
        ctx_1 === null || ctx_1 === void 0 ? void 0 : ctx_1.closePath();
    });
    //캔버스를 벗어난 경우
