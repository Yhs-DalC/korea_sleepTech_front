...
// 2. 제네릭 필요성
// - 코드 중복을 줄임, 타입 안정성을 보장('컴파일'시점에 타입을 체크)
...
console.log(pair2<string, string[]>('hello','hi'));//[ 'hello', 'hi' ]
...
let mtGenenricNumber = new GenericClass<number>(0, (x, y) => x + y);
