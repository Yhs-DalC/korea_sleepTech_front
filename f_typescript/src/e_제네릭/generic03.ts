...
function updateUser(id: number, changes: Partial<User>){
  ...
  // 3) name, age 둘 다 있는 경우: {name, age, name, age} >> 모든 값이 changes로 수정
  // 4) name, age 둘 다 없는 경우: 수정 X
...
// user.age = 30;// 읽기 전용 속성이므로 'name'에 할당할 수 없습니다
