...
// >> 정해져있지 않은 T타입에 .length 속성의 존재 유무를 확인할 수 없어 에러
//    EX) number, boolean 타입은 해당 속성이 없음
...
console.log(constraints({
  length: 10,// 필수속성만 명시 되어 있으면 가능 - length 속성을 반드시 포함(구조적 타이핑)
  value: 3,
  addedOption: 'hi'
}));
