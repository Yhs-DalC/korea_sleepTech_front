...
function setAlignment(align: 'left' | 'center' | 'right'){
  ...
  // container.style.textAlign = aligin;
}
setAlignment('center');
...
//? 리터럴 타입을 활용한 유니언 타입 사용 시 여러 타입의 데이터 혼합 가능
...
// userProfile.address.city = 'Daejeon';// 읽기 전용 속성이므로 city에 할당 불가능
...
let userData: UserDataType = {
  ...
  age: 29,
  isStudent: false,
  // hobby: ['exercise', 'reading']// 필요한 형식은 이 인덱스 시그니처에서 가져옵니다 - 해당 인덱스 서명에 존재하지 않는 타입의 값
}
userData.email = 'devgiant75';
