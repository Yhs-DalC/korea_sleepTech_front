...
const user: {
  ...
  height: number;
  favorite: any;
  age: number;// 타입에서 명시한 속성은 반드시 객체 내부에 존재해야 함
} = {
  // 객체 내부에서 각 속성읙 구분 ,(콤마)로 표시
  name: '이승아',
  height: 169,
...
//! 읽기 전용 속성
// : 속성명 앞에 readonly 키워드를 사용하여 해당 속성의 재할당을 금지시킨다
...
// readonlyuser.age = 20; // 읽기 전용 속성이므로 재할당 할 수 없습니다
